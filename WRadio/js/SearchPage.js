/*
    ...
    About code: This code handles the search result for the radio stations. Any search query entered in the search box will retrieve the
                matching result via API call and render on the screen. The API support maximum of 30 stations per page. Hence the number
                of stations per page have been hardcoded in the URL.
    Credits:    1] Prof. Richard Rasala: Hash change handling in this code has been inspired from the Alice in Wonder land single page App.
                   The code is at : http://net4.ccs.neu.edu/home/rasala/.
...
$(document).ready(function () {
    ...
    function stationContentLoad() {
        ...
        if (window.location.search.split('?').length > 1) {
            ...
            error = "Please provide search query parameter"
    ...
    function getCategoryStations(queryString, pageNo) {
        ...
        var catStationUrl = baseUrl + "search/" + query + "/" + token + "&page=" + pageNo + "&per_page=30" + urlEnd;
